 ...
 *  each antenna.
 *
 *  Example: Initialize an estimator, setup the parameters, create the estimator
 *  and calculate an angle estimate from previously captured I/Q samples.
 *  Finally, deinitialize the estimator after returning the angles.
 *
 *  @code
 *    // Estimator instance
...
/**************************************************************************//**
 *  Angle of Arrival / Angle of Departure (AoA / AoD) API
 *****************************************************************************/
 ...
 * @note: This function should be called only after the estimator is created.
 *****************************************************************************/
...
{
  SL_RTL_LOC_ESTIMATION_MODE_TWO_DIM, ///< Two-dimensional mode - Only X and Y plane considered
  SL_RTL_LOC_ESTIMATION_MODE_THREE_DIM, ///< Three-dimensional mode - Covers X, Y and Z planes
...
{
  SL_RTL_LOC_TARGET_PARAMETER_PROCESS_NOISE_COVARIANCE, ///< Process noise covariance of the locationing filter process
...
enum sl_rtl_loc_result
{
  ...
  SL_RTL_LOC_RESULT_POSITION_COVARIANCE, ///< Estimated position covariance of the target
  SL_RTL_LOC_RESULT_VELOCITY_COVARIANCE, ///< Estimated velocity covariance of the target
  SL_RTL_LOC_RESULT_ACCELERATION_COVARIANCE, ///< Estimated acceleration covariance of the target
